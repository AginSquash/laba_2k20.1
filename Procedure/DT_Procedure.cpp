...
std::string parseInt(int value, int length) {
...
int addDateTime(int year, int mon, int day, int hour, int min, int sec, int dt_year, int dt_mon, int dt_day, int dt_hour, int dt_min, int dt_sec) {
...
bool checkDate(int year, int mon, int day, bool isAddingDate) {
    switch (mon)
    {
        case 1:
        case 3:
...
int create(int year, int mon, int day, int hour, int min, int sec, int dt_year, int dt_mon, int dt_day, int dt_hour, int dt_min, int dt_sec)
{
